...
class MyApp:
    ...
    def create_main_window(self):
        ...
        self.root.title("Autosamatic ver4.2.1")
    ...
    def group_by_order(self, file_input, dtype):
        ...
        str_cols = df.select_dtypes(include=['object']).columns  # * pandas มอง object เป็น string
        ...
        seller_discount_df = df.groupby('orderNumber')[
...
class Bot_POS:
    ...
    def get_customer_name_ready(self, cus_search_input, is_last_page: bool = False):
        ...
        while not self.operation_thread.is_set():
            try:
                ...
                print(f"Error in selecting customer name: {err}")
                time.sleep(0.5)
                try:
    ...
    def select_cus_name_from_lis(self, cus_desire_name, cus_name_list, cb=""):
        ...
        try:
            if cb and not cus_desire_name in customer_current_input_name:
