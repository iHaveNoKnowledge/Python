...
# * 223 /Feat/ 4.2.0 เพิ่มปุ่ม Finish เพื่อให้จบการทำงานของ bot ได้ง่ายขึ้น
...
#! 4.2.0, 4.2.1 critical bugs ค่าขนส่งกับราคามัน fix กรอกหน้าท้าย ถ้าหน้าแรกไม่ตรงกับหน้าท้าย มันทะลุ ตัว validate ของ smco ได้เลย ทำให้ยอดที่ยิงลงบิลไม่ตรงกับยอดกรอกตอนท้าย
