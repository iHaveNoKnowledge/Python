...
#! 218 /issue/ address_corrector() เมื่อเป็นภาษาอังกิด ให้เช็ค compare self.current_address ในส่วนของ ตำบล อำเภอ แบบภาษษาอังกฤษ แทนภาษาไทย ไม่งั้นมันจะไม่ match แล้วมันจะต้องแก้ไข address ตลอด
