...
# ! 199 /Bug/ 4.1.0 ตัวเลือก cp แบบใหม่ ยที่มันควรจะเกบชื่อ cp มาเลือกอันต่อไป มันกลับเลือกตาม index ในตัวที่ idx>0 อยู่ดี มันควรจะเลือกจาก idx แค่ตัวแรก ตัวต่อไปเลือกจาก ชื่อ cp ที่เหลือ
