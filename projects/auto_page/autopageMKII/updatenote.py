...
#! 224 /issues/ select_cus_name_from_lis() มีปัญหาเลือกลูกค้าสาขาย่อยที่ไม่มีเลขสาขาได้ สรุปลูกค้า personal จะถูกมองว่าเปนสาขาย่อย มันจะตีไม่ได้เเพราะขาด logic รองรับ พวกย่อยแต่ไม่มีเลขสาขา
