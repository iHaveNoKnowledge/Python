...
# ? 155 patch 3.1.1 /แก้แล้วมั้ง/ ปรับให้ไม่รับ sn ซ้ำ และไม่สร้าง col ของซ้ำใหม่ แต่บัคป่าววะไม่ชัว /Bug/ ตอนรับ pdf มาออกไฟล์ excel นั้น น่าจะไม่มี algorithm ในการตรวจสอบว่ามี column ซ้ำหรือไม่ มันซ้ำแล้ว push แบบเพิ่ม .1 เข้ามา เช่น หากใน file มี CO3-000922 เวลา push ไฟล์ใหม่ลงมามันจะได้ col ใหม่้เป็น CO3-000922.1 แทนที่มันจะใส่ลง CO3-000922 เดิม
