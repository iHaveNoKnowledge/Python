...
# * 192 /Fixed/ 4.1.0 หายละ /Bug/  เวลากดใช้ auto add bot แม่งดับทันที
# ! 193 /Issue/ แบบย่อแบบเต็ม มันจะมีปัญหาเรื่องของไม่เคลียตอนยิ่งใหม่ แน่นอน
# ! 194 /Issue/ แบบย่อแบบเต็ม มันจะมีปัญหาหน้าท้ายก่อนกดปุ่มเขียวแน่นอน เรื่อง จะอออกหรือไม่ออกใบกำกับ เพราะฟังชันเลือกใบกำกับ สำหรับหน้าหลังทำไม่ทัน
