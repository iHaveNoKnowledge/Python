...
# * 192 /Fixed/ 4.1.0 auto_add_product() ให้แยก thread แก้ปัญหา thread ดับตอน กด auto_add_product() /Bug/  เวลากดใช้ auto add bot แม่งดับทันที
...
# * 198 /Fixed/ 4.1.0 ตัว reset memory เหมือนจะดีขึ้น แต่ไม่ชัว
