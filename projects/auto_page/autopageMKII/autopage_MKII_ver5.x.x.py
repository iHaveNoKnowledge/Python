...
class Bot_POS:
    def __init__(self, parent, app):
        ...
        self.marketplace_scraper = MarketplaceScraper(self)
    ...
    def operation_start(self):
        ...
        if self.app.order != "" and not self.operation_thread.is_set():
            ...
            # Scrape and verify marketplace order
            ...
            if marketplace_result.purchased_channel:
                self.operation_states['purchased_channel'] = marketplace_result.purchased_channel
