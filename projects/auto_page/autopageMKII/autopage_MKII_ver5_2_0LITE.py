...
class MyApp:
    ...
    def create_main_window(self):
        ...
        self.root.title("Autosamatic ver5.2.0LITE")
                    ...
                    # กรณีที่ 2: marketplace_item_price < smco_item_price? (diff < 0)
                        ...
                        if cp_info:
                            ...
                            if is_valid_adjustment(dc_amount_str):
                                ...
                                self.app.update_log(f"📉 ปรับราคาลด (Discount) จากข้อมูลแคมเปญ: {dc_amount_str} x {item_qty} = {total_dc} บาท")
                    ...
                    if post_verification.get("all_ok"):
                        ...
                        if self.app.is_accel_mode.get() and self.app.is_auto_invoice_mode.get():
                            ...
                            if has_warning:
                                ...
                                self.app.update_log(f"❌ พบข้อผิดพลาดจากป๊อปอัป (ไม่มี Serial): {err_msg}")
