...
driver= webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=opt) ##download new ver.
...
def addNormalCustomer(cusSearchSMCO, cusCreateBtn):
    ...
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[3]/div[1]/input').send_keys(tax_name_g)
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[3]/div[2]/input').send_keys(tax_name_g)
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[7]/div/textarea').send_keys(tax_address_g)
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[14]/div[2]/input').send_keys(tax_tel_g)
...
def addTaxInvCustomer(cusSearchSMCO, cusCreateBtn):
    ...
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[3]/div[1]/input').send_keys(tax_name_g) ##nameTH
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[3]/div[2]/input').send_keys(tax_name_g) ##nameEN
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[3]/div[3]/input').send_keys(tax_ID) ##Identity ID
    ...
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[7]/div/textarea').send_keys(address_detail_only) ##Address
    ...
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/span/span/span[1]/input').send_keys(province) ##province input
    time.sleep(1.55)
    ...
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/span/span/span[1]/input').send_keys(district) ##District  
    time.sleep(1.55)
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/span/span/span[1]/input').send_keys(Keys().ENTER)
    ...
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/span/span/span[1]/input').send_keys(sub_district) ##SubDistrict
    time.sleep(1.55)
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/span/span/span[1]/input').send_keys(Keys().ENTER)

    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[14]/div[2]/input').send_keys(tax_tel_g) ##tel.
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[16]/center/button[1]').click()
...
tax_name
def search_order():
    searchBtn = driver.find_element(By.XPATH,'/html/body/div[1]/div[1]/div[3]/div[3]/div[2]/section/div[2]/div[2]/form/div[2]/div[4]/div/button[2]')
    searchBtn.click()
    search_result_element = wait.until(EC.text_to_be_present_in_element((By.XPATH,'/html/body/div[1]/div[1]/div[3]/div[3]/div[2]/section/div[3]/div[2]/table/tbody/tr/td[2]'), order)) ##ดูผลลัพว่าใช้ order ที่เราเสิชจริงๆหรือไม่ เป็น bool
...
def customer_details(raw_data):
    ...
    if result:
        ...
        address_detail_postal = address_detail_only.split(" ")[-1] ##ดึงเลข ปณ จาก ก้อน string 
        ...
        if type(int(float(address_detail_postal)))==int:
            ...
            address_detail_only = str(re.sub(address_detail_only.split(" ")[-1],'', address_detail_only))
        else:
            print("ไม่ int")
...
searchInput = wait.until(EC.visibility_of_element_located((By.XPATH,'/html/body/div[1]/div[1]/div[3]/div[3]/div[2]/section/div[2]/div[2]/form/div[1]/div[1]/fieldset/div/input'))) ##ช่อง input
searchInput.clear()
...
while True:
    ...
    if search_order():
        ...
        break
##เข้าไปใน detail
driver.find_element(By.XPATH,'/html/body/div[1]/div[1]/div[3]/div[3]/div[2]/section/div[3]/div[2]/table/tbody').click()
...
wait.until(EC.text_to_be_present_in_element((By.XPATH,'/html/body/div[2]/div[3]/div/div/div[1]/div/div/div/div/h5'),'Copied billing address'))
