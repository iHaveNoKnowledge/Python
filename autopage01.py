...
## หลักๆ ใช้ setup
import time
import win32com.client as comclt ##ไม่รู้คือไร แต่ใช้แล้ว มันทำให้ควบคุม context เมนูได้
import re
...
##functions
def loginShopee():
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div/div/div/div[3]/div/div/div/div[2]/button').click()
    time.sleep(1)

    subLoginName = driver.find_element(By.XPATH,'/html/body/div/main/div/div[1]/div/div/div/div/div/div/div[2]/div[1]/div/div/div/input')
    subLoginName.clear()
    subLoginName.send_keys(LoginData.id)

    subLoginPw = driver.find_element(By.XPATH,'/html/body/div/main/div/div[1]/div/div/div/div/div/div/div[2]/div[3]/div/div/input')
    subLoginPw.clear()
    subLoginPw.send_keys(LoginData.pw)

def addNormalCustomer(cusSearchSMCO, cusCreateBtn):
    element = wait.until(EC.visibility_of_element_located((By.XPATH,cusSearchSMCO)))
    element.click() ##กดแว่นขยาย
    btnElement = wait.until(EC.visibility_of_element_located((By.XPATH,cusCreateBtn)))
    ...
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[7]/div/textarea').send_keys(cus_normal_address)
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[14]/div[2]/input').send_keys(1)
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[16]/center/button[1]').click()
    driver.find_element(By.XPATH,'/html/body/div[16]/div[2]/button[1]').click()
...
def addTaxInvCustomer(cusSearchSMCO, cusCreateBtn):
    ...
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[3]/div[1]/input').send_keys(taxName) ##nameTH
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[3]/div[2]/input').send_keys(taxName) ##nameEN
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[3]/div[3]/input').send_keys(taxID) ##Identity ID
    [finAddress, finSubdistrict, finDistrict, finProvince, finZipCode] = addressExtractor(taxAddress) ##ปัญหา บางเคสลูกค้าใส่ comma มามากกว่า 5 อัน ทำให้ error 
    finProvince = finProvince.strip().lstrip("จังหวัด")
    
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[7]/div/textarea').send_keys(finAddress) ##Address

    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[9]/div[1]/div/span/span[1]/span/span[1]').click() ##dropdown Country
    time.sleep(1)
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/span/span/span[2]/ul/li[2]').click() ##select thailand in dropdown

    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[9]/div[2]/div/span/span[1]/span/span[1]').click() ##province dropdown
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/span/span/span[1]/input').send_keys(finProvince) ##province input
    time.sleep(1.75)
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/span/span/span[1]/input').send_keys(Keys().ENTER)

    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[11]/div[1]/div/span/span[1]/span/span[1]').click() ##District drop
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/span/span/span[1]/input').send_keys(finDistrict.strip().lstrip("เขต").replace("อำเภอ", "")) ##District  
    time.sleep(1.75)
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/span/span/span[1]/input').send_keys(Keys().ENTER)

    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[11]/div[3]/div/span/span[1]/span/span[1]').click() ##SubDistrict drop
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/span/span/span[1]/input').send_keys(finSubdistrict.strip().lstrip("แขวง").replace("ตำบล", "")) ##SubDistrict
    time.sleep(1.75)
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/span/span/span[1]/input').send_keys(Keys().ENTER)

    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[14]/div[2]/input').send_keys(taxTel) ##tel.
    driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[11]/div/div/div[3]/div/form/div[16]/center/button[1]').click()
    driver.find_element(By.XPATH,'/html/body/div[16]/div[2]/button[1]').click()
...
if x:
    if titleList.count("SMCO :: เปิดการขาย") == 1:
        driver.execute_script("window.open('http://115.31.167.28:8080/smartcore/smartpos/posmain.htm');")
    elif titleList.count("SMCO :: เปิดการขาย") >= 2:
        pass
else:
    driver.execute_script("window.open('http://115.31.167.28:8080/smartcore/smartpos/posmain.htm');")
    driver.execute_script("window.open('http://115.31.167.28:8080/smartcore/smartpos/posmain.htm');") #ใช้ได้ๆ มันออกมาจริง แต่ บราวเซอร์มันจะตกใจ popup
...
searchInput = wait.until(EC.visibility_of_element_located((By.XPATH,'/html/body/div[1]/div[2]/div[2]/div/div/div[2]/div[2]/div/div/div[1]/div[2]/div[2]/div[1]/span[2]/div/div[1]/div/div/input'))) ##ช่อง input
# orderResult = wait.until(EC.)
searchInput.clear()
searchInput.send_keys(order)
print("ช่องเสิชมีอะไร",searchInput.get_attribute("value"))
##คลิกปุ่ม search
searchBtn = driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div[2]/div/div/div[2]/div[2]/div/div/div[1]/div[2]/div[2]/div[2]/button[1]')
searchBtn.click()
time.sleep(1.5)
...
foundLi = waitLi.until(EC.visibility_of_element_located((By().XPATH,foundOrderElement)))
try:
    wait = WebDriverWait(driver,1)
    element = wait.until(EC.text_to_be_present_in_element((By.XPATH,'/html/body/div[1]/div[2]/div[2]/div/div/div[2]/div[2]/div/div/div[2]/div/div[2]/a/div[1]/div[2]/span[1]'),text_="Invoice Requested"))
    if element:
        print("มีใบกำกับ")
        taxBool = True
    foundLi = driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div[2]/div/div/div[2]/div[2]/div/div/div[2]/div/div[2]/a')
...
wait = WebDriverWait(driver, 30)
wait.until(EC.visibility_of_element_located((By.XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[1]'))) ##ดูว่า div แรกออกมายัง
time.sleep(1.5)
cusName = ""
...
if taxBool:
    try: ##ตรวจดูว่ามี คำว่า "สำนักงานใหญ่หรือไม่" ถ้ามีให้เก็บมา ไม่มีให้ข้ามไปใส่ปกติ
        head_office_str = driver.find_element(By.XPATH,head_office_str_elmt).text
        taxName = driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[2]/div/div[4]/div[2]/div[2]/div[2]/div[1]/div[1]/div[2]').text
        taxName = remove_text(taxName)
        taxName = taxName+" "+"("+head_office_str+")" ##จะได้ ชื่อบริษัท (สำนักงานใหญ่) 
    except:
        print("ใส่คำว่า (สำนักงานใหญ่) ไม่ได้")
        taxName = driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[2]/div/div[4]/div[2]/div[2]/div[2]/div[1]/div[1]/div[2]').text
        pass

    taxAddress = driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[2]/div/div[4]/div[2]/div[2]/div[2]/div[1]/div[2]/div[2]').text
    taxID = driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[2]/div/div[4]/div[2]/div[2]/div[2]/div[2]/div[1]/div[2]').text
    try:
        if driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[2]/div/div[4]/div[2]/div[2]/div[2]/div[2]/div[2]').is_enabled():
            taxTel = driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[2]/div/div[4]/div[2]/div[2]/div[2]/div[2]/div[2]/div[2]').text
        else:
            pass
    except:
    ...
    wait.until(EC.visibility_of_element_located((By.XPATH, '/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[5]/div/div/div/div/div/div[2]')))
    cus_account_Name_element_v2 = driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[2]/div/div[4]/div[2]/div[2]/div[2]/div[1]/div[1]/div[2]')
    ...
    cus_normal_address_Element = driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[2]/div/div[4]/div[2]/div[2]/div[2]/div[1]/div[2]/div[2]')
...
try:
    ...
    try:   
        ...
        isShippingCost = wait_few_sec.until(EC.text_to_be_present_in_element((By.XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[5]/div/div/div/div/div[2]/div[3]'),"ค่าจัดส่ง"))
        if(isShippingCost):
            shippingCostValue = driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[5]/div/div/div/div/div[2]/div[4]')##ต้องเปิดก่อนมันมองไม่เหน path นี้
            shippingCostValue = currencyRemover(shippingCostValue.text)
    except:
        isShippingCost = wait.until(EC.text_to_be_present_in_element((By.XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[5]/div/div/div/div/div[2]/div[5]'),"ค่าจัดส่ง"))
        if(isShippingCost):
            shippingCostValue = driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[5]/div/div/div/div/div[2]/div[6]')##ต้องเปิดก่อนมันมองไม่เหน path นี้
            shippingCostValue = currencyRemover(shippingCostValue.text)
    ...
    element2 = driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[5]/div/div/div/div[2]') ##แหวก dropdownแบบที่2
    element2.click()
    time.sleep(0.55)
    shippingCostValue = driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div/div/div/div/div/div/div/div[1]/div[1]/div[5]/div/div/div[2]/div[4]')
    shippingCostValue = currencyRemover(shippingCostValue.text)
...
if taxBool: ##ถ้าเป็นจริง = มีใบกำกับ
    ...
    time.sleep(8) ##แอดไม่ทันเสร็จ มันไปเลือกชื่อลูกค้าแล้ว error เลยเพราะหา element ต่อไปไม่เจอ
    print("ครบ 10 วิหลังใช้ เพิ่มชื่อ tax") ## ตอนแรก รอ 3, 5 วิ แล้วไม่ทัน แต่ 10 ทัน รันสบาย
...
handles = driver.window_handles 
driver.switch_to.window(merged_dict['SMCO :: เปิดการขาย']) ## เปิดครั้งแรก การสลับมาหน้า 1 มันขึ้น out of range โดย เวลานั้น บรรทัด 281 ยังไม่มี handles = driver.window_handles ตอนนี้ใส่เพิ่มแล้วไม่รู้จะเป็นอีกไหม
try:
...
try:
    if int(shippingCostValue) != int(0):
        skuInput = wait.until(EC.visibility_of_element_located((By.XPATH,'/html/body/div[1]/div[2]/div[2]/div[2]/div[1]/div[1]/from/div/div/div[1]/div[1]/span/input')))
        ...
        skuAddBtn = wait.until(EC.visibility_of_element_located((By.XPATH,'/html/body/div[1]/div[2]/div[2]/div[2]/div[1]/div[1]/from/div/div/div[1]/div[1]/span/input')))
        ...
        definePrice = wait.until(EC.visibility_of_element_located((By.XPATH,'/html/body/div[1]/div[2]/div[2]/div[2]/div[1]/div[2]/div[1]/div/div[2]/div[1]/div[1]/div/a[1]'))) ##ทำไมต้องใส่วงเล็บ คลุม BY.XPATH เพราะ ถ้าไม่ใส่ ฟังชัน visibility จะมอง xpath เป็น argument ที่สอง ของ method visibility
        ...
        definePrice.click()
        time.sleep(1)
        print("กดที่ SKU ELEMENT 1 สำเร็จ") ##ค่าขนส่งโดนข้า230208FX99FUGGมหลังจากตรงนี้

        changePriceInput = driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div[2]/div[2]/div[6]/div/div/div[2]/div[2]/div[1]/input')
        changePriceInput = changePriceInput.clear()
        changePriceInput = driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div[2]/div[2]/div[6]/div/div/div[2]/div[2]/div[1]/input').send_keys(shippingCostValue)
        driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div[2]/div[2]/div[6]/div/div/div[2]/div[2]/div[2]/input').send_keys("62078")
        driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div[2]/div[2]/div[6]/div/div/div[2]/div[2]/div[3]/input').send_keys("ITcity@2021")
        driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div[2]/div[2]/div[6]/div/div/div[2]/div[5]/div/textarea').send_keys("Online")
        
        driver.find_element(By().XPATH,'/html/body/div[1]/div[2]/div[2]/div[2]/div[6]/div/div/div[2]/div[6]/a[1]').click()
    else:
...
zeroExpectElmt =  wait2.until(EC.text_to_be_present_in_element((By.XPATH,'/html/body/div[1]/div[2]/div[6]/form/div[2]/div/div[2]/div[4]/div'),"0.00"))
...
if zeroExpectElmt:
    ...
    time.sleep(2.5) ##รอ popup เลข บิลมันโผล่ ต้องใช้เวลานิดนึง เอาจริงๆเวลาไม่ค่อยแน่นอนอาจจะต้องใช้ wait
    wait.until(EC.visibility_of_element_located((By.XPATH,"/html/body/div[16]/div[2]/button[1]"))).click()
...
###กรณี Printing Paper
finalPrintRadio = "/html/body/div[1]/div[2]/div[6]/div[1]/div/div/div[2]/div/div[1]/label/input" ##popup สุดท้าย ใช้อันนี้เพื่อ print กรณี ใบกำกับ False
finalPrintBtn = "/html/body/div[1]/div[2]/div[6]/div[1]/div/div/div[2]/div/div[5]/center/button" ##popup สุดท้าย ปุ่มส่งเมลเพื่อจบการทำงาน (locatorเดียวกับปุ่มsend email)
###กรณี Sending email
finalSendEmailRadio = "/html/body/div[1]/div[2]/div[6]/div[1]/div/div/div[2]/div/div[2]/label/input" ##popup สุดท้าย ใช้อันนี้ เพื่อส่งเมล คู่กับ ใบกำกับ True
finalEmailInputElmt = "/html/body/div[1]/div[2]/div[6]/div[1]/div/div/div[2]/div/div[3]/div[3]/input" ##popup สุดท้าย ช่องinput สำหรับกรอก email
finalSendEmailBtn = "/html/body/div[1]/div[2]/div[6]/div[1]/div/div/div[2]/div/div[5]/center/button" ##popup สุดท้าย ปุ่มส่งเมลเพื่อจบการทำงาน (locatorเดียวกับปุ่มPrint)
