...
# ! 157 /Bug/ จาก 152 กรณี หาไม่เจอ หรือ add แล้วเจอซ้ำ มันจะวนมาใส่และหาชื่อลูกค้าใหม่แต่ไม่ได้แก้ทันที !!มันควรจะแก้ไขทันทีเมื่อเจอpop-upชื่อซ้ำ!!
...
#! 161 /bug/ ตอน add ชื่อลูกค้าใหม่ dropdown Customer class ชอบโดนข้าม งง ทั้งๆที่ดัก element แล้วเลือกไว้แล้วแท้ๆ
