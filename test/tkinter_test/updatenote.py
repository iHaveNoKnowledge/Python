...
# ! 166 /Bug Hint/ การใช้ while not self.operation_thread.is_set() เพื่อดักการทำงานของ thread มันอาจจะทำให้ threadใหม่ ดับ ซึ่งเกิดมาจาก thread ใหมที่ที่กำลังเริ่ม พร้อมกับ thread เก่าที่กำลังถูกตัด
