...
# ? 157 /confuse/ ยังอยู๋ป่าววะไม่เจอเหตุการนี้เลย /Bug/ จาก 152 กรณี หาไม่เจอ หรือ add แล้วเจอซ้ำ มันจะวนมาใส่และหาชื่อลูกค้าใหม่แต่ไม่ได้แก้ทันที !!มันควรจะแก้ไขทันทีเมื่อเจอpop-upชื่อซ้ำ!!
...
#! 160 /Bug/ กรณีหาชื่อและเทียบใน li ไม่เจอมันนิ่งส์ไม่รู้ทำไรต่อ มีแต่รอ timeout จนหมดเวลาแล้วมันก็จบการทำงานไป
# ? 161 /กำลังแก้/เทสกับลูกค้าปกติไปแล้ว ดูเหมือนจะไม่ติดปัญหาละ แต่ยังไม่ได้ลองเทสกับใบกำกับ /bug/ ตอน add ชื่อลูกค้าใหม่ dropdown Customer class ชอบโดนข้าม งง ทั้งๆที่ดัก element แล้วเลือกไว้แล้วแท้ๆ
