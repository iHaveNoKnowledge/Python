...
# ! 143 ไม่สามารถ ใช้กับ shopee mobile ได้ ในหน้าท้าย เนื้องจาก หน้าท้าย มันจะมีให้เลือกว่าจะจ่ายช่องทางไหน ซึ่ง shopee ธรรมดา กับ mobile ใช้ช่องทางแยกกัน
...
# * 145 patch 0.398.9 // แก้บัค accel mode  บางกรณีตัวแปร used_serial อาจไม่ได้ถูกสร้าง แต่มีการเรียกใช้และรับ used_serial เป็น parameter ตลอดเวลา
# * 146 patch 0.398.9 // ปรับวิธีการเลือก li ใน dropdown หลังกรอก เสิชเลขใบกำกับ โดยเอาคำที่บอกประเภทการจัดตั้งออก('บจก.', 'บริสัส', 'จำกัด', ...., 9ล9) focus ไปที่การหาด้วยชื่อ
