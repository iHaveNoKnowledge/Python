...
# ! 139 // shopee มันมี mobile เพิ่มขึ้นมาอีกอัน ฉะนั้น ใหน้าสุดทั้าย มันจะต้อง มีตรรกะแยกว่า ก่อนจะเลือก shopee ต้องพิจาณาก่อนว่าเป็น mobile หรือไม่
...
# * 148 patch 0.399.2 // ปรับ regex ในการตรวจหาเลขบิลก่อนหน้า print ทำให้หาเลขบิลได้ทุก pos แน่นอล // ปัญหาเกิดจาก regex หา เลขบิลจาก popup ที่แสดงเลขบิลก่อนหน้าปริ้นมัน สามารถใช้กับเลขบิลของ pos w เท่านั้น แต่ pos mobile กับ pos g(ไรไม่รู้) จะมีเลขบิลที่ต่างออกไปทำให้ regex เดิมใช้ไม่ได้
