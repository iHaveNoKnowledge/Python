...
# ! 140 // pdf sn extractor ไม่สามารถดึง sn ที่มีตัวอักษรพิเศษปะปน ในปัจจุบันเจอ sn ที่มี "/" ทำให้ดึงไม่ออก ไฟล์ตัวอย่างมี คือ "TRB018325050500012-Tranfer" เป็น sn ของ xiaomi 
